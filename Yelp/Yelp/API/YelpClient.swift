...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func search(with term: String, offset:Int?, limit:Int?, completion: @escaping ([Business]?, Int?,Error?) -> Void) -> AFHTTPRequestOperation {
        return search(with: term, offset:offset, limit:limit,  sort: nil, categories: nil, deals: nil, completion: completion)
    }
    
    func search(with term: String, offset:Int?, limit:Int?, sort: YelpSortMode?, categories: [String]?, deals: Bool?, completion: @escaping ([Business]?, Int?,Error?) -> Void) -> AFHTTPRequestOperation {
